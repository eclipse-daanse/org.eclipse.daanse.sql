...
*/
package org.eclipse.daanse.sql.jdbc.importer.csv.api;

public class Constants {
    private Constants() {
    }

    public static final String PID_CSV_DATA_IMPORTER = "org.eclipse.daanse.sql.jdbc.importer.csv.CsvDataImporter";
