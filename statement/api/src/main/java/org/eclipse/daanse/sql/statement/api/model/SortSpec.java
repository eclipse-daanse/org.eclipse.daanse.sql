...
public record SortSpec(SortDirection direction, boolean nullable, NullOrder nullOrder, boolean prepend,
        String nullSortValue, org.eclipse.daanse.sql.model.type.Datatype nullSortDatatype,
     ...
     */
    public SortSpec withNullSortValue(String value, org.eclipse.daanse.sql.model.type.Datatype datatype) {
